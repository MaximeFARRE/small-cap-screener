...
**Version 2.0.0 — local-first research terminal for French small & mid caps**
...
- Migration to a **web architecture**: React frontend + FastAPI backend
- New **panel-based workspace** (Screener, Tearsheet, Signals, Watchlist)
- **Server-side business logic** (scoring, filtering, ranking, exports)
- Improved **data refresh and universe import workflows**
- Cleaner separation of concerns for maintainability and AI-assisted development
...
- repositories own persistence and provider I/O
...
### Universe & Enrichment
- Euronext France universe discovery/import
- Ticker and ISIN ingestion
- Yahoo Finance enrichment with fallback logic
- Data freshness and quality indicators

### Scoring & Screening
- Multi-factor deterministic scoring (Quality / Value / Growth / Risk)
- Global and sector ranking
- Filterable/sortable screener
- Snapshot-based comparison workflows

### Analyst Workflow
- Tearsheet with KPIs, score breakdown, historical financials
- Peer comparison and signal panels
- Watchlist with memo/status management

### Export
- CSV and Excel exports from filtered/snapshot views
...
Frontend runs on Vite dev server and proxies API calls to `/api`.
